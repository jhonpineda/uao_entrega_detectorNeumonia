...
# OTHER MODULES
import BackendReadImg
import BackendPredict
...
class Frontend():
    ...
    def load_img_file(self):
        ...
        if filepath:            
            ...
            ##--------UPLOAD FOR IMAGE --------            
            self.array, img2show = BackendReadImg.read_img_file(filepath)
    ...
    def run_model(self):
        ...
        self.label, self.proba, self.heatmap = BackendPredict.predict(self.array) 
